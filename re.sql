...
-- Volcando estructura de base de datos para re
CREATE DATABASE IF NOT EXISTS `re` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `re`;

-- Volcando estructura para tabla re.tvkm
CREATE TABLE IF NOT EXISTS `tvkm` (
  `idvkm` int(11) NOT NULL AUTO_INCREMENT,
  `ValorKM` float NOT NULL,
  PRIMARY KEY (`idvkm`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla re.tvkm: 1 rows
/*!40000 ALTER TABLE `tvkm` DISABLE KEYS */;
INSERT INTO `tvkm` (`idvkm`, `ValorKM`) VALUES
	(1, 20);
/*!40000 ALTER TABLE `tvkm` ENABLE KEYS */;

-- Volcando estructura para tabla re.t_chofer
...
-- Volcando datos para la tabla re.t_chofer: ~4 rows (aproximadamente)
...
INSERT INTO `t_chofer` (`idch`, `Nombre`, `Celu`, `Tel`, `Reg`, `Domicilio`, `Status`) VALUES
	...
	(4, 'chofer xxxxxb', '9999', 456, '00212', 'calle t', 1),
...
-- Volcando estructura para tabla re.t_clientes
CREATE TABLE IF NOT EXISTS `t_clientes` (
  ...
  PRIMARY KEY (`idcli`)
) ENGINE=MyISAM AUTO_INCREMENT=852 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla re.t_clientes: 850 rows
...
-- Volcando estructura para tabla re.t_distancia
CREATE TABLE IF NOT EXISTS `t_distancia` (
  `iddis` int(11) NOT NULL AUTO_INCREMENT,
  `Lugar` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `distancia` float NOT NULL,
  PRIMARY KEY (`iddis`),
  UNIQUE KEY `iddis` (`iddis`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla re.t_distancia: 6 rows
/*!40000 ALTER TABLE `t_distancia` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t_distancia` ENABLE KEYS */;

-- Volcando estructura para tabla re.t_modo
CREATE TABLE IF NOT EXISTS `t_modo` (
  `idmo` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando datos para la tabla re.t_modo: ~10 rows (aproximadamente)
...
-- Volcando estructura para tabla re.t_movil
...
-- Volcando datos para la tabla re.t_movil: 2 rows
/*!40000 ALTER TABLE `t_movil` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t_movil` ENABLE KEYS */;

-- Volcando estructura para tabla re.t_operadora
CREATE TABLE IF NOT EXISTS `t_operadora` (
...
-- Volcando datos para la tabla re.t_operadora: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `t_operadora` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t_operadora` ENABLE KEYS */;

-- Volcando estructura para tabla re.t_turno
CREATE TABLE IF NOT EXISTS `t_turno` (
  ...
  `um` int(11) NOT NULL,
  `umt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Volcando datos para la tabla re.t_turno: 2 rows
/*!40000 ALTER TABLE `t_turno` DISABLE KEYS */;
INSERT INTO `t_turno` (`idtur`, `choid`, `autoid`, `feini`, `fecie`, `kmini`, `kmfin`, `um`, `umt`, `opini`, `opfin`, `monto`, `estado`) VALUES
	(1, 1, 2, '2017-04-05 00:00:00', '2017-04-05 00:00:00', 100, 200, 0, '2017-04-30 16:14:14', 1, 0, 0, 1),
	(2, 2, 1, '2017-04-05 00:00:00', '2017-04-05 00:00:00', 100, 200, 0, '2017-04-30 16:14:37', 1, 0, 0, 2);
/*!40000 ALTER TABLE `t_turno` ENABLE KEYS */;

-- Volcando estructura para tabla re.t_version
...
-- Volcando datos para la tabla re.t_version: 1 rows
...
-- Volcando estructura para tabla re.t_viaje
...
-- Volcando datos para la tabla re.t_viaje: 0 rows
/*!40000 ALTER TABLE `t_viaje` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_viaje` ENABLE KEYS */;

-- Volcando estructura para tabla re.ver
...
-- Volcando datos para la tabla re.ver: 4 rows
...
-- Volcando estructura para disparador re.t_turno_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `t_turno_before_delete` BEFORE DELETE ON `t_turno` FOR EACH ROW BEGIN 
UPDATE t_version 
  SET ver=(1+ver) 
  WHERE  idv='1'; 
END//
...
-- Volcando estructura para disparador re.t_turno_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `t_turno_before_insert` BEFORE INSERT ON `t_turno` FOR EACH ROW BEGIN
UPDATE t_version 
  SET ver=(1+ver) 
  WHERE  idv='1'; 
END//
...
-- Volcando estructura para disparador re.t_turno_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `t_turno_before_update` BEFORE UPDATE ON `t_turno` FOR EACH ROW BEGIN 
UPDATE t_version 
  SET ver=(1+ver) 
  WHERE  idv='1'; 
END//
